...
if not modules_loaded:
	...
	__all__ = ['JBWEnvCOMP579Transferv1']

	class JBWEnvCOMP579Transferv1(gym.Env):
...
class _JBWEnvAgent(Agent):
	...
	def do_next_action(self):
		if np.random.uniform() > 0.9:
			...
			all_act = [RelativeDirection.FORWARD, RelativeDirection.LEFT, RelativeDirection.RIGHT, RelativeDirection.BACKWARD]
			self.move(all_act[np.random.randint(0, 4)])
